...
pub const BRIDGES: &[Bridge] = &[
    // shared method cores
    b("shared/text.rs", "str_core", "Str"),
    b("shared/text.rs", "color_core", "Str"),
    b("shared/numbers.rs", "num_core", "*"),
    b("shared/numbers.rs", "float_extra", "*"),
    b("shared/text.rs", "char_method", "Char"),
    b("shared/regex.rs", "regex_core", "Regex"),
    b("shared/regex.rs", "match_core", "Match"),
    b("shared/regex.rs", "captures_core", "Captures"),
    b("shared/time.rs", "duration_core", "Duration"),
    b("shared/time.rs", "datetime_core", "DateTime"),
    b("shared/scalars.rs", "status_core", "Status"),
    b("shared/scalars.rs", "header_value_core", "HeaderValue"),
    b("shared/scalars.rs", "exit_status_core", "ExitStatus"),
    b("shared/json.rs", "json_type_test", "*"),
    ...
    b("ed25519_bridge.rs", "verifying_key_method", "VerifyingKey"),
    b("ed25519_bridge.rs", "signature_method", "Signature"),

...
fn fixture() -> (PathBuf, PathBuf) {
    ...
    write(&root.join("shared/Cargo.toml"), r#"[package]
name = "shared"
version = "0.0.0"
edition = "2024"
[dependencies]
[workspace]
"#);
    write(&root.join("shared/src/lib.rs"), "pub mod greet;\npub mod util;\n");
    write(&root.join("shared/src/util.rs"), "pub fn who() -> String { \"world\".to_string() }\n");
    ...
    write(&root.join("shared/src/greet.rs"), "pub fn hi() -> String { format!(\"hi {}\", super::util::who()) }\n");

    write(&root.join("app/Cargo.toml"), r#"[package]
name = "app"
version = "0.0.0"
edition = "2024"
[dependencies]
...
"#);
    ...
    write(&bin, "#!/usr/bin/env rust\nuse shared::greet::hi;\nmod deep;\nfn main() {\n    println!(\"{}\", hi());\n    deep::go();\n}\n");
    write(&root.join("app/src/bin/deep/mod.rs"), "use shared::util::who;\npub fn go() { println!(\"deep {}\", who()); }\n");

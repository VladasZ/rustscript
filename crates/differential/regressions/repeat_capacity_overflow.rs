//! `repeat` past the allocation limit must panic with `capacity overflow`
//! and exit 101. The interpreter once died in its own allocator with exit 1.
//! From seeds 20686107380 and 20686204456.

...
use crate::lang::ty::{TRACE_DEF, TRACE_NAME};
...
impl Program {
    pub fn render(&self) -> String {
        ...
        if body.contains(TRACE_NAME) {
            items.push_str(TRACE_DEF);
        }
        ...
        if !items.starts_with(TRACE_DEF) && items.contains(TRACE_NAME) {
            items.insert_str(0, TRACE_DEF);
        }

...
`all`, `any`, `as_str`, `by_ref`, `cloned`, `collect`, `collect_string`, `copied`, `filter`, `filter_map`, `find`, `for_each`, `last`, `map`, `max`, `min`, `next`, `peek`, `peekable`, `position`, `rev`, `skip_while`, `take_while`, `to_vec`
